<template>
    <div class="wrapbody">
    <vue-headful
            title="Cài đặt - Chào mừng đến với iBee"
      ...
      <Row>
        ...
        <Col :xs="6" :sm="6" :md="5" :lg="4">
            ...
            <ul class="sidebarLeft" style="background: #ffae2a;">
                <router-link :to="{ path: '/app/settings/liveSettings'}"><li style="color:#FFF">BẢNG QUẢN TRỊ</li></router-link>
            </ul>
            <ul class="sidebarLeft">
                <router-link :to="{ path: '/app/settings/liveSettings'}"><li>CÀI ĐẶT LIVE <status-indicator negative pulse></status-indicator></li></router-link>
            </ul>
             <ul class="sidebarLeft">
                ...
                this.$Notice.warning({
                    ...
                    render: h => {
                        return h('span', [
                            'Để " ',
                            h('b', 'BẮT ĐẦU LIVE'),
                            ' " xin hãy vào "', h('b', 'QUẢN LÝ CÀI ĐẶT > CÀI ĐẶT LIVE'), '". Xin cám ơn!'
                        ])
                    }
                });
            }
